...
const saveProduct = (array) => {
    ...
    const productProperties = Object.defineProperties(products);
    console.log(productProperties);
    for(let i =0; i < array.length; i++ ){
        let newItem = array[i].Object();
             newItem[array[i]] = new Object();
         newItem[getKeys(productPropsKeys)] = getValues(productPropsValues);
         newItem[getKeys(productPropsKeys)] = getValues(productPropsValues);
