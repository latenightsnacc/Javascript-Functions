...
saveProduct1(products);

const saveProduct2 = (array) => {
     ...
     console.log(props);
     savedProducts = array.reduce((key, value) =>(key[value]=[props.reduce((k,v) => (k[v] = k,v),{})],key),{});
     console.log(savedProducts);
};

saveProduct2(products);
